    ...
    <body>
        ...
        <main>
            ...
            <div id="albumes">
                <div id="cabecera">
                    <table>
                <tr><th><td>TITULO</td></th><th><td>DURACION</td></th></tr>
                    </table>
                </div>
            <table>
            ...
            <div id="inicio">
                <a href="pagina_playlist.xml"><button>ATRAS</button></a>
        ...
        <xsl:template match="playlist">
            ...
            <tr>
            <td><xsl:value-of select="cancion[//playlist[@id='pl03']]/titulo/text()"/></td>
